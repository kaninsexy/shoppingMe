            ...
            <Row>
              <Col className='ml-auto mr-auto text-center' md='8'>
                ...
                <h5 className='description'>
                  We are nobdy. Abosulutely nobody seriously. This is just for
                  testing out my shopping cart nothing more nothing less. If you
                  still reading this you either have to much free time or you
                  are hook up.Either way, stop wasting time reading this and go
                  to other page already!.
                </h5>
              </Col>
            </Row>
              ...
              <Row>
                <Col md='6'>
                  ...
                  >
                    <p
                      style={{ color: 'black' }}
                      className='blockquote blockquote-secondary'
                    >
                      "Over the span of the satellite record, Arctic sea ice has
                      been declining significantly, while sea ice in the
                      Antarctichas increased very slightly" <br></br>
                      <br></br>
                      <small style={{ color: 'black' }}>-Kanin</small>
                    </p>
                  </div>
                  <div
