...
const MapWrapper = withScriptjs(
  withGoogleMap((props) => (
    <GoogleMap
      defaultZoom={13}
      defaultCenter={{ lat: 13.7253711, lng: 100.5293195 }}
      defaultOptions={{
        scrollwheel: false,
        styles: [
          {
    ...
    <>
      ...
      <div className='wrapper'>
              ...
              <Row>
                <Col className='ml-auto mr-auto' md='5'>
                  ...
                  <p className='description'>
                    You can contact us with anything related to our Shoping
                    Cart. We'll get in touch with you as soon as possible.{' '}
                    <br></br>
                    <br></br>
                  </p>
                ...
                <Col className='ml-auto mr-auto' md='5'>
                  <div className='info info-horizontal mt-5'>
                    ...
                    <div className='description'>
                      ...
                      <p>
                        Bld BB Comeeting Space Chongnonsee 7652 Bangkok,
                        <br></br>
                        Thailand
                      </p>
                    </div>
                  ...
                  <div className='info info-horizontal'>
                    ...
                    <div className='description'>
                      ...
                      <p>
                        Kanin Srijundorn <br></br>
                        +66-87-999-1244 <br></br>
                        Mon - Fri, 8:00-22:00
                      </p>
                    </div>
                  </div>
        ...
        <div className='big-map' id='contactUs2Map'>
          <MapWrapper
            googleMapURL='https://maps.googleapis.com/maps/api/js?key=AIzaSyDuoPVFa0jD6U8Ty9I2ZyA7ylEFuOnevGM'
